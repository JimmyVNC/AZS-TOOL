...
- **Điều khiển màn hình ngoài (DDC/CI):**
  ...
  - Hỗ trợ gán **Phím tắt độ sáng tùy chỉnh** hoạt động toàn hệ thống.
- **Quản lý quạt tản nhiệt (Fan Control):**
  - Đọc thông số RPM thực tế qua giao tiếp AppleSMC.
  - Cho phép điều chỉnh tốc độ quạt thủ công hoặc chuyển về chế độ Tự động của hệ thống.
- **Tùy chỉnh Chuột & Cuộn chuột:**
  - **Đảo chiều cuộn toàn hệ thống:** Đảo ngược hướng cuộn cho chuột ngoài độc lập hoặc toàn bộ hệ thống.
  - **Tùy chỉnh phím chuột (Mouse Remap):** Gán chức năng linh hoạt cho các nút bấm mở rộng (Button 3 đến Button 10) như Mở Spotlight, Cửa sổ ứng dụng, v.v.**
...
được phát triển thêm các tính năng như hình 
