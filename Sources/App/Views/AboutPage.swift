        ...
        GeometryReader { proxy in
            ScrollView {
                VStack(spacing: 0) {
                    ...
                    Text("Bộ gõ tiếng Việt và bộ tiện ích cá nhân cho macOS")
                        .font(.callout)
                    ...
                    VStack(spacing: 10) {
                        ...
                        InfoRow(icon: "computermouse",
                                title: "Tiện ích hệ thống",
                                caption: "Đảo cuộn toàn máy, gán nút chuột, điều khiển âm lượng và độ sáng màn hình.")
                    }
                    .padding(.top, 18)
                    ...
                    Text("Phát triển bởi **JimmyVNC** · © 2026")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
